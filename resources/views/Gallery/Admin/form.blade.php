            ...
            <div class="container-fluid">
                <div class="row">
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="/admin/gallery/create" enctype="multipart/form-data" files="true" url="apply/multiple_upload">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Cover Picture</label>
                                        <div class="col-md-6">
                                            <input type="file" class="form-control" name="picture" id="picture" required="required" multiple="true">
                                        </div>
                                    </div>
                                    <div class="form-group">
