...
@section('content')
    <div class="gallery_container">
        ...
        <div style="padding: 0; width: 100%; margin: 0; font-family:Arial, Verdana;background-color: transparent;">
        ...
        height: 456px; background: #191919; overflow: hidden;">
                ...
                <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 356px; overflow: hidden;">
                    ...
                    <div>
                        <img u="image" src="{{ $galleries -> picture }}" />
                        <img u="thumb" src="{{ $galleries -> picture }}" />
                    </div>
                    @endforeach
                </div>
