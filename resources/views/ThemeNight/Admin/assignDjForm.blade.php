            ...
            <div class="container-fluid">
                <div class="row">
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="/admin/theme-night/assignDj" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Available Djs</label>
                                        <div class="col-md-6">
                                            <select name="themeNightDjId" class="form-control">
