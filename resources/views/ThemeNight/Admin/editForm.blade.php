            ...
            <div class="container-fluid">
                <div class="row">
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="/admin/theme-night/update/{{ $themeNight->id }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="name" value="{{ $themeNight->name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <textarea class="form-control" name="description" value="{{ $themeNight->description }}"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
