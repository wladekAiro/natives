            ...
            <div class="container-fluid">
                <div class="row">
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="/admin/theme-night/addPartner" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Available Partners</label>
                                        <div class="col-md-6">
                                            <select name="themeNightPartnerId" class="form-control">
