            ...
            <div class="container-fluid">
                <div class="row">
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="/admin/event/addSponsor" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Sponsor</label>
                                        <div class="col-md-6">
                                            <select name="eventSponsorId" class="form-control">
