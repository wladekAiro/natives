...
<style>
    ...
    */
	...
	<div style="margin:0;padding:0; background:#fff; font-family: Arial, Verdana, Sans-Serif;">
	...
	<div style="position: relative; margin-top: 10px; top: 0px; left: 0px; width:100%; text-align: center; background:url('/images/1.jpg') no-repeat;background-size: cover; border-top: 1px solid gray; border-bottom: 1px solid gray; overflow: hidden;">
		<!-- Jssor Slider Begin -->
...
<div class="body4">
    <a href="/Resturant" class="btn btn-default btn1">Resturant</a>
    <a href="/Nightlife" class="btn btn-default btn2">Club & night</a>
</div>
