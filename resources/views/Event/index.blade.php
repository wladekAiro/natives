    ...
    <div class="event_container">
        ...
        <div style="padding: 0; margin: 0; font-family: Arial, Verdana; background-color: transparent;">
            ...
            <div style="position: relative; width: 100%; background-color: transparent; overflow: hidden;">
                ...
                top: 0px; left: 0px; width: 980px; height: 400px; background: url(/images/1.jpg) top center no-repeat;">
                        <!-- Loading Screen -->
                    ...
                    height: 400px; overflow: hidden;">
                            ...
                            <span style="display: block; line-height: 1.1em; font-size: 1.5em; color: #FFFFFF;">
                                {{ $event -> description }}
                                    ...
                                    <img src="{{ $event -> picture }}" style="position: absolute; top: 23px; left: 480px; width: 500px; height: 300px;" />
                                    <img u="thumb" src="{{ $event -> picture }}" />
                                </div>
                            ...
                            {{--</span>--}}
                                    ...
                                    {{--<a href="http://www.jssor.com">--}}
                                        {{--<img src="../images/img/major/find-out-more-bt.png" border="0" alt="ebay slideshow" width="215"--}}
                                             {{--height="50" />--}}
                                    {{--</a>--}}
                                {{--</div>--}}
                                {{--<img src="../images/img/major/s3.png" style="position: absolute; top: 23px; left: 480px; width: 500px; height: 300px;" />--}}
                                {{--<img u="thumb" src="../images/img/major/s3t.jpg" />--}}
                            {{--</div>--}}
                            {{--<div>--}}
                                {{--<div style="position: absolute; width: 480px; height: 300px; top: 10px; left: 10px;--}}
                            {{--text-align: left; line-height: 1.8em; font-size: 12px;">--}}
                            ...
                            {{--</span>--}}
                                    ...
                                    {{--<br />--}}
                                    {{--<a href="http://www.jssor.com">--}}
                                        {{--<img src="../images/img/major/find-out-more-bt.png" border="0" alt="listing slider" width="215"--}}
                                             {{--height="50" />--}}
                                    {{--</a>--}}
                                {{--</div>--}}
                                {{--<img src="../images/img/major/s4.png" style="position: absolute; top: 23px; left: 480px; width: 500px; height: 300px;" />--}}
                                {{--<img u="thumb" src="../images/img/major/s4t.jpg" />--}}
                            {{--</div>--}}
                            {{--<div>--}}
                                {{--<div style="position: absolute; width: 480px; height: 300px; top: 10px; left: 10px;--}}
                            {{--text-align: left; line-height: 1.8em; font-size: 12px;">--}}
                            ...
                            {{--</span>--}}
                                    ...
                                    {{--<br />--}}
                                    {{--<a href="http://www.jssor.com">--}}
                                        {{--<img src="../images/img/major/find-out-more-bt.png" border="0" alt="ebay store slider" width="215"--}}
                                             {{--height="50" />--}}
                                    {{--</a>--}}
                                {{--</div>--}}
                                {{--<img src="../images/img/major/s5.png" style="position: absolute; top: 23px; left: 480px; width: 500px; height: 300px;" />--}}
                                {{--<img u="thumb" src="../images/img/major/s5t.jpg" />--}}
                            {{--</div>--}}
                            {{--<div>--}}
                                {{--<div style="position: absolute; width: 480px; height: 300px; top: 10px; left: 10px;--}}
                            {{--text-align: left; line-height: 1.8em; font-size: 12px;">--}}
                            ...
                            {{--</span>--}}
                                    ...
                                    {{--<br />--}}
                                    {{--<a href="http://www.jssor.com">--}}
                                        {{--<img src="../images/img/major/find-out-more-bt.png" border="0" alt="listing template slider"--}}
                                             {{--width="215" height="50" />--}}
                                    {{--</a>--}}
                                {{--</div>--}}
                                {{--<img src="../images/img/major/s6.png" style="position: absolute; top: 23px; left: 480px; width: 500px; height: 300px;" />--}}
                                {{--<img u="thumb" src="../images/img/major/s6t.jpg" />--}}
                            {{--</div>--}}
                            {{--<div>--}}
                                {{--<div style="position: absolute; width: 480px; height: 300px; top: 10px; left: 10px;--}}
                            {{--text-align: left; line-height: 1.8em; font-size: 12px;">--}}
                            ...
                            {{--</span>--}}
                                    ...
                                    {{--<br />--}}
                                    {{--<a href="http://www.jssor.com">--}}
                                        {{--<img src="../images/img/major/find-out-more-bt.png" border="0" alt="auction template slider"--}}
                                             {{--width="215" height="50" />--}}
                                    {{--</a>--}}
                                {{--</div>--}}
                                {{--<img src="../images/img/major/s7.png" style="position: absolute; top: 23px; left: 480px; width: 500px; height: 300px;" />--}}
                                {{--<img u="thumb" src="../images/img/major/s7t.jpg" />--}}
                            {{--</div>--}}
                            {{--<div>--}}
                                {{--<div style="position: absolute; width: 480px; height: 300px; top: 10px; left: 10px;--}}
                            {{--text-align: left; line-height: 1.8em; font-size: 12px;">--}}
                            ...
                            {{--<span style="display: block; line-height: 1.1em; font-size: 2.5em; color: #FFFFFF;">--}}
                                ...
                                {{--<br />--}}
                                {{--<a href="http://www.jssor.com">--}}
                                    {{--<img src="../images/img/major/find-out-more-bt.png" border="0" alt="ebay slider" width="215"--}}
                                         {{--height="50" />--}}
                                {{--</a>--}}
                                {{--</div>--}}
                                {{--<img src="../images/img/major/s8.png" style="position: absolute; top: 23px; left: 480px; width: 500px; height: 300px;" />--}}
                                {{--<img u="thumb" src="../images/img/major/s8t.jpg" />--}}
                            {{--</div>--}}
                        </div>
                        ...
                        <style>
                            ...
                            */
                            .jssora07l, .jssora07r {
                                ...
                                height: 50px;
                                cursor: pointer;
                                background: url(../images/img/a07.png) no-repeat;
                                overflow: hidden;
                            }
