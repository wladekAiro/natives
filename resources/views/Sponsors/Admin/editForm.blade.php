            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a href="#" class="navbar-brand">Sponsor(s)</a>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="/admin/sponsor/update/{{ $partner->id }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Brief description</label>
                                        <div class="col-md-6">
                                            <textarea class="form-control" name="description" value="{{ $sponsor->description }}"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
